...
in
{
  ...
  # Per-user Claude Code config. The package comes from the NixOS half
  # above; this owns ~/.claude/settings.json, the only piece that is
  # meaningfully user-scoped (preferences, attribution, default permission
  # mode).
  #
